        ...
        public override void OnInspectorGUI()
        {
            ...
            if (mode.value.enumValueIndex == ((int)VolumetricFogMode.On))
            {
                ...
                void DrawQualitySettings()
                {
                    ...
                    EditorGUILayout.LabelField(
                        new GUIContent(
                            "Estimated VRAM Usage (MB): " + obj.EstimatedVram.ToString("0.00"),
                ...
                void SetLowQualitySettings()
                {
                    ...
                    gridPixelSize.value.intValue = 50;
                    gridSizeZ.value.intValue = 64;
                }

                void SetMediumQualitySettings()
                {
                    p_noiseQuality.intValue = 1;
                    gridPixelSize.value.intValue = 20;
                    gridSizeZ.value.intValue = 96;
                }

                void SetHighQualitySettings()
                {
                    p_noiseQuality.intValue = 2;
                    gridPixelSize.value.intValue = 8;
                    gridSizeZ.value.intValue = 128;
                }

                void SetUltraQualitySettings()
                {
                    p_noiseQuality.intValue = 3;
                    gridPixelSize.value.intValue = 4;
                    gridSizeZ.value.intValue = 160;
                }
            }
        }
    }
