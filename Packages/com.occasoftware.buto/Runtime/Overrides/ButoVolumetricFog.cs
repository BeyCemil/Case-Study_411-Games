...
namespace OccaSoftware.Buto.Runtime
{
    ...
    public sealed class ButoVolumetricFog : VolumeComponent, IPostProcessComponent
    {
        ...
        public NoInterpMinIntParameter gridPixelSize = new NoInterpMinIntParameter(20, 3);
        public NoInterpClampedIntParameter gridSizeZ = new NoInterpClampedIntParameter(96, 32, 192);
        ...
        public Vector3Int VolumeSize
        {
            get
            {
                volumeSize.x = Screen.currentResolution.width / gridPixelSize.value;
                volumeSize.y = Screen.currentResolution.height / gridPixelSize.value;
        ...
        public Vector3 CellSize
        {
            get
            {
                cellSize.x = 1.0f / VolumeSize.x;
                cellSize.y = 1.0f / VolumeSize.y;
                cellSize.z = 1.0f / VolumeSize.z;
                return cellSize;
            }
        }
        ...
        public MinFloatParameter depthRatio = new MinFloatParameter(1.5f, 0.5f);
